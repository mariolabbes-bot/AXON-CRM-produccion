...
const PlannerPage = () => {
    ...
    return (
        <Box sx={{ pb: 12, bgcolor: 'background.default', minHeight: '100vh' }}>
            ...
            <Paper elevation={0} sx={{ p: 2, borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, zIndex: 10 }}>
                <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                    <Box>
                        <Typography variant="h5" fontWeight="bold" color="primary.main">Planificar Ruta</Typography>
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                    <Paper sx={{ p: '2px 4px', display: 'flex', alignItems: 'center', flex: 1, borderRadius: 3, border: '1px solid rgba(255,255,255,0.1)', elevation: 0, bgcolor: 'rgba(255,255,255,0.03)' }}>
                        <InputBase
                            sx={{ ml: 1, flex: 1 }}
            ...
            <Box p={2}>
                ...
                {Array.isArray(filteredSuggestions) && filteredSuggestions.map(client => {
                    ...
                    return (
                        <Paper
                            ...
                            sx={{
                                ...
                                border: isSelected ? '2px solid' : (isAlreadyPlanned ? '1px solid' : '1px solid'),
                                borderColor: isSelected ? 'primary.main' : (isAlreadyPlanned ? 'secondary.main' : 'rgba(255,255,255,0.05)'),
                                bgcolor: isAlreadyPlanned ? 'rgba(32, 168, 146, 0.1)' : (isSelected ? 'rgba(224, 107, 50, 0.1)' : 'background.paper'),
                                transition: 'all 0.2s',
                    ...
                    <Grid item xs={12} md={4}>
                        <Paper sx={{ p: 2, borderRadius: 4, position: 'sticky', top: 120, border: '1px solid rgba(255,255,255,0.08)', bgcolor: 'background.paper', maxHeight: 'calc(100vh - 200px)', overflowY: 'auto' }}>
                            <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                            ...
                            {selected.length === 0 ? (
                                ...
                                suggestions.filter(c => selected.includes(c.rut)).map(client => (
                                    <Paper key={`sel-${client.rut}`} sx={{ p: 1.5, mb: 1, bgcolor: 'rgba(255,255,255,0.03)', borderRadius: 2, border: '1px solid rgba(255,255,255,0.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        <Box>
            ...
            <Paper
                ...
                sx={{
                    ...
                    bgcolor: 'rgba(11, 15, 25, 0.9)', backdropFilter: 'blur(20px)'
                }}
            >
