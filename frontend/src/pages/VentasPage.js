    ...
    return (
        <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
            ...
            <Box sx={{ mb: 4, display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <Accordion defaultExpanded sx={{ bgcolor: 'transparent', boxShadow: 'none', '&:before': { display: 'none' }, borderBottom: '1px solid #e2e8f0' }}>
                    ...
                    <Autocomplete
                        ...
                        size="small"
                        sx={{ flexGrow: 1, minWidth: { xs: '100%', sm: 350 }, bgcolor: 'background.paper' }}
            ...
            <Paper sx={{ p: 0, overflow: 'hidden', borderRadius: 2, boxShadow: 3 }}>
                <Box sx={{ p: 2, bgcolor: 'rgba(255, 255, 255, 0.03)', borderBottom: '1px solid rgba(255, 255, 255, 0.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <Table sx={{ minWidth: 900 }}>
                            <TableHead sx={{ bgcolor: 'rgba(255, 255, 255, 0.02)' }}>
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'rgba(255, 255, 255, 0.05)' }}>Mes Actual</TableCell>
                                ...
                                {data.length === 0 ? (
                                    ...
                                    data.map((row, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'rgba(255, 255, 255, 0.03)' }}>
            ...
            >
                {selectedProduct && (
                    <>
                        <DialogTitle sx={{ bgcolor: 'rgba(255, 255, 255, 0.05)', color: 'text.primary', fontWeight: 'bold' }}>
                            Ficha de Producto
                        </DialogTitle>
                        <DialogContent dividers>
                            ...
                            {selectedProduct.stock_desglose ? (
                                <List dense sx={{ bgcolor: 'rgba(255, 255, 255, 0.02)', borderRadius: 2, border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                            ...
                            <Box sx={{ mt: 3, display: 'flex', justifyContent: 'flex-end' }}>
                                <Typography variant="subtitle1" sx={{ fontWeight: 'bold', px: 2, py: 1, bgcolor: 'rgba(255, 255, 255, 0.05)', borderRadius: 2 }}>
